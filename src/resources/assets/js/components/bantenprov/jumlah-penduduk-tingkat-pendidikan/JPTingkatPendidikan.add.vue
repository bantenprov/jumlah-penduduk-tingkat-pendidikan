      ...
      <div class="col-md-8 col-lg-9 admin-main">
        ...
        <div class="col-md-12">
          <div class="card mb-3">
            ...
            <div class="card-body">
            <b-card header="Tambah Jumlah Penduduk Berdasarkan Tingkat Pendidikan" header-tag="h4" class="bg-success-card">
...
miniToastr.init();
export default {
    name: "jumlah_penduduk_tingkat_pendidikan_add",
    components: {
        Datepicker
    },
    data() {
        return {
            jumlah_penduduk_tingkat_pendidikans: [],
            provinces: [],
            regencies: {},
            formstate: {},
            model: {
    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/jumlah-penduduk-tingkat-pendidikan/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/jumlah-penduduk-tingkat-pendidikan/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/jumlah-penduduk-tingkat-pendidikan/create'
                  }
                },
                window.location.href = '#/admin/jumlah-penduduk-tingkat-pendidikan/create')
        ...
        back() {
            window.location = '#/admin/jumlah-penduduk-tingkat-pendidikan';
        }
    },
    mounted: function() {
        axios.get("/jumlah-penduduk-tingkat-pendidikan/create").then(response => {
