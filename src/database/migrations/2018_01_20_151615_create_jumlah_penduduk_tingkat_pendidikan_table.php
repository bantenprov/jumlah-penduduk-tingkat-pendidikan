...
class CreateJPTingkatPendidikanTable extends Migration {

	public function up()
	{
		Schema::create('jumlah_penduduk_tingkat_pendidikans', function(Blueprint $table) {
			$table->increments('id');
	...
	{
		Schema::drop('jumlah_penduduk_tingkat_pendidikans');
	}
}